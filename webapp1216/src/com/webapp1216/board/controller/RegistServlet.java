//jsp나 servlet이나 둘 다 웹서버에서 해석 및 실행되어지므로, 글 등록 요청을 처리할 때는
//둘 다 가능하다. 하지만, 현재 시점에서 jsp로 개발하지 않는 이유는?
//앞으로 jsp는 서블릿의 디자인적 처리시 단점을 보완하기 위해서 개발된 기술이므로,
...
public class RegistServlet extends HttpServlet{
	...
	//글쓰기를 처리하는 서블릿이므로, 클라이언트의 요청이 post로 들어온다.. 따라서 doXXX 형중에서 doPost로 받자!
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/html;charset=utf-8"); //<- 아래처럼 나눠도 됨
